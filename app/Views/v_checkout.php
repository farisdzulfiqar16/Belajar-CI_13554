    ...
    $('document').ready(function() {
        ...
        $("#kabupaten").on('change', function() {
            ...
            $.ajax({
                ...
                data: {
                    'origin': 399,          //399 adalah kode untuk Kota Semarang.
                    'destination': id_city, //destinasi kota dengan/melalui ID
                    'weight': 1000,         //Berat barang 1000gram atau 1kg.
                    'courier': 'jne'        //Expedisi yang digunakan adalah JNE.
                },
                dataType: 'json',
                success: function(data) {
                    //console.log(data);
